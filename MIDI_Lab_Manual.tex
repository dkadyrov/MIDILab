...
\begin{figure*}[h]
\centering
\includegraphics[width=.85\textwidth]{LaTeX/Room.png}
...
%Synthesizers:
%\begin{itemize}
%	\item[] \textbf{Korg Triton}
%	\item[] \textbf{Roland D50} 
%	\item[] \textbf{EMU Proteus 2000} 
%\end{itemize}
%
%Audio Equipment
%\begin{itemize}
%	\item[] \textbf{Mackie CR1601 VLZ Mixer}	: 16 channel audio mixer with ability to send audio to effects processor, other keyboards (for sampling), and for recording on the iMac as well as to a personal computer through a personal audio interface.
%	\item[] \textbf{DMV Pro-Audio Effects Processor} 
%	\item[] \textbf{Alesis M1 Active Mk2 Studio Monitors}
%	\item[] \textbf{Line 6 Audio Interface}
%\end{itemize}
%
%
%MIDI Components
%\begin{itemize}
%	\item[] \textbf{MOTU MIDI Interface}: Allows MIDI communication and control between the iMac and the synthesizers 
%	\item[]	\textbf{Yamaha Clavinet}: Used as the primary MIDI controller within the MIDI Lab setup.
%\end{itemize}
%
%Other Devices
%\begin{itemize}
%	\item[] \textbf{Apple iMac 2009}: The computer provided within the MIDI Lab. Ableton Live and Logic Pro 10 are installed. 
%\end{itemize}
%
%\end{fullwidth}
